...
?>
    ...
    <div class="content">
        ...
        <form class="box" name="Delivery" action="Delivery Details.php" onsubmit="return delivery(this); method="post">
           ...
           <div class="re">
            ...
            <div class="submission">
                <input type="submit" class="confirm" value="Proceed to Payment">
            </div>
