...
<head>
    ...
    <title>Privacy Policy - Store 2 Door</title>

    <link href="Stylesheets/Header and Footer.css" rel="stylesheet" type="text/css" />
    <link href="Stylesheets/Privacy Policy.css" rel="stylesheet" type="text/css" />
...
?>
    ...
    <div class="content">
        ...
        <p>This company uses the collected data for various purposes: </p>
        ...
        <p>
            If you are located outside Sri Lanka and choose to provide information to us, please note that 
            we transfer the data, including personal Data, to Sri Lanka and process it there.
        </p>
        ...
        <p>
            This Company will take all steps reasonably necessary to ensure that your data is treated 
        ...
        <p>
            This Company may disclose your personal Data in the good faith belief that such action 
            is necessary to:
        </p>

        <ul>
            <li>To comply with a legal obligation </li>
            <li>To protect and defend the rights or property of this company </li>
        ...
        <ul>
            ...
            <li>By visiting this page on our website: 
                <a href= "Contact Us.html" target="_blank" id="contact">http://www.store2door.com/contact_us </a>
            </li>
