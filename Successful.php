...
<head>
    ...
    <title>Successful Purchase - Store 2 Door</title>
...
<body>
    ...
    <div class="content">
        ...
        <p>You have successfully made the purchase!</p>
        <p>Your purchased items will be delivered soon.</p>
        <p>Thank you!</p>
        <p>If you want to contact us, click <a href="Contact Us.html">here</a>.</p>
